...
// Set new authentication strategy
    ...
    // Assign the role
    roleBasedAuthenticationStrategy.assignRole(RoleBasedAuthorizationStrategy.GLOBAL, adminRole, globalRoleAdmin);
    println "[INIT-DEBUG] Admin role created"
    ...
    println "[INIT-DEBUG] Basic Read role created..."

    // Save the state
    println "[INIT-DEBUG] Saving changes."
